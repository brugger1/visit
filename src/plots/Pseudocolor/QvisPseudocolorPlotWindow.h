...
//   Added lineSettings, endPointSettings and pointTypeSettings methods which
//   allow changing the visibility and/or enabled state of certain controls
//   based on the rendering type(s) in effect.
//
// ****************************************************************************
